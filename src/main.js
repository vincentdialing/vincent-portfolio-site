...
if (heroCopyStackEl && heroHeadingGroupEl && heroHeadingEl && heroRoleWrapEl && heroLeadEl && heroRoleEl && heroDescEl) {
  ...
  const lockHeroTextHeights = () => {
    ...
    const shouldLockHeroLines = window.matchMedia('(max-width: 768px)').matches;
    ...
    heroCopyStackEl.style.minHeight = shouldLockHeroLines ? `${Math.ceil(maxCopyHeight)}px` : '0';
...
const knowledgeBase = {
  ...
  smmApproach: ["social media", "smm", "organic and paid growth", "content strategy", "marketing"],
...
const responses = {
  ...
  skills: "I specialize in Graphic Design, Video Editing, Social Media Management, and UI/UX Design. I've produced 350+ digital designs across B2B, SaaS, and branded content — all with proven organic and paid growth results.",
  ...
  coreSkills: "My core skills are Graphic Design, Social Media Management, Video Editing, and UI/UX Design. I've produced 500+ creative assets, driven organic and paid audience growth, and managed 15+ weekly deliverables across distributed teams.",
  ...
  smmApproach: "I focus on organic and paid growth strategies. At Harmonia Chorale, I produced 150+ designs that drove massive audience growth. I manage everything from content calendars and daily engagement to campaign execution and analytics.",
  ...
  harmonia: "At Harmonia Polifonica Chorale, I was Head Creatives and Lead Social Media Manager for nearly 4 years. I produced 150+ digital designs, grew the page through organic and paid strategies, directed video productions, and launched their website which generated 25+ client inquiries.",
